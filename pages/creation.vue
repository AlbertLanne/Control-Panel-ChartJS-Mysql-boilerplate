<template>
  <div class=" min-h-screen bg-gray-600 flex-wrap text-copy-primary flex flex-wrap font-mono">

    <div class="my-16 items-center border-2 border-blue-800 -p-1 px-4 h-8 border-white block rounded-full bg-blue-400">
      <p class=" text-xl text-center ">button</p>
    </div>

    <div class="w-full h-full ">
      <div class="w-8/12 justify-center h-full ">
        <p class=" m-6 mx-auto text-6xl font-thin"> Creation </p>
